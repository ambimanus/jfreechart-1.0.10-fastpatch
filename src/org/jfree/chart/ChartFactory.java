...
public abstract class ChartFactory {
     ...
     * {@link #createXYStepChart(String, String, String, XYDataset, PlotOrientation, boolean, boolean, boolean)}.
     *
     * @param title  the chart title (<code>null</code> permitted).
     * @param xAxisLabel  a label for the X-axis (<code>null</code> permitted).
     * @param yAxisLabel  a label for the Y-axis (<code>null</code> permitted).
     ...
     * @return A chart.
     */
    public static JFreeChart createXYStepChartFast(String title,
                                               String xAxisLabel,
                                               String yAxisLabel,
                                               XYDataset dataset,
                                               PlotOrientation orientation,
        ...
        XYItemRenderer renderer 
            = new XYStepRendererFast(toolTipGenerator, urlGenerator);

        FastXYPlot plot = new FastXYPlot(dataset, xAxis, yAxis, null);
        plot.setRenderer(renderer);
        plot.setOrientation(orientation);
        plot.setDomainCrosshairVisible(false);
        plot.setRangeCrosshairVisible(false);
    ...
    /**
	 * FAST implementation of
	 * {@link #createTimeSeriesChart(String, String, String, XYDataset, boolean, boolean, boolean)}.
	 * 
	 * @param title
	 ...
	 * @return A time series chart.
	 */
    public static JFreeChart createTimeSeriesChartFast(String title,
                                                   String timeAxisLabel,
                                                   String valueAxisLabel,
                                                   XYDataset dataset,
                                                   boolean legend,
        ...
        NumberAxis valueAxis = new NumberAxis(valueAxisLabel);
        valueAxis.setAutoRangeIncludesZero(false);  // override default
        FastXYPlot plot = new FastXYPlot(dataset, timeAxis, valueAxis, null);
        ...
        StandardXYItemRendererFast renderer = new StandardXYItemRendererFast(
				StandardXYItemRendererFast.LINES, toolTipGenerator,
				urlGenerator);
        plot.setRenderer(renderer);

...
public class ChartRenderingInfo implements Cloneable, Serializable {
    ...
    /**
     * Storage for the the initial translation parameters for the chart.
     */
    private AffineTransform initTranslation;
...
////////////////// Added to support appended draw:Start ////////////////////////
    /**
        * Returns the initial chart translation.
        *
        * @return The initial chart translation.
        */
       public AffineTransform getInitTranslation() {
           return this.initTranslation;
       }

       /**
        * Sets the initial chart translation.
        *
        * @param trans  The initial chart translation.
        */
       public void setInitTranslation(AffineTransform trans) {
           this.initTranslation = trans;
    }
